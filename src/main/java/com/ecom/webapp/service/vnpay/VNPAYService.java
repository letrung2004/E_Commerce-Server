package com.ecom.webapp.service.vnpay;

import com.ecom.webapp.config.VNPAYConfig;
...
import static com.ecom.webapp.config.VNPAYConfig.vnp_HashSecret;
...
//        String calculatedHash = VnpayUtils.hashAllFields(fields, vnp_HashSecret); // bạn cần viết hoặc import VnpayUtils
